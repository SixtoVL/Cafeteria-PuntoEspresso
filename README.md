...
| :--- | :---: | :--- | :--- |
| **Proyecto Funcional** | **4.0 pts** | `App.tsx`<br>`index.css`<br>`main.tsx` | El sitio web es completamente funcional, interactivo, y adapta su interfaz a dispositivos móviles y de escritorio. Cuenta con pantalla de carga inicial interactiva y un **Panel del Evaluador** (modal académico accesible mediante el botón `i` flotante) para ingresar datos del alumno sustentante sin romper el diseño de producción. |
...
*   **Comprobación Académica:** Se diseñó un modal flotante y discreto en el archivo [App.tsx](file:///D:/Desktop/ProgramacionMultimedia/cafeteria-puntoespressoUI/src/App.tsx#L117-L163) que permite registrar y validar en tiempo real los datos del sustentante (Nombre y Matrícula) para agilizar la labor de evaluación del docente.
